...
language_data = {
    "english": {
        ...
        Upload a video, subtitle, audio file or provide a URL video link. 📽️ **Gets the updated notebook from the official repository.: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "spanish": {
        ...
        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "french": {
        ...
        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "german": {
        ...
        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "italian": {
        ...
        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "japanese": {
        ...
        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "chinese_zh_cn": {
        "description": """
          ...
          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "ukrainian": {
        ...
        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "arabic": {
        "description": """
          ...
          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "russian": {
        ...
        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "turkish": {
        ...
        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "indonesian": {
        ...
        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "portuguese": {
        ...
        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "hindi": {
        "description": """
          ...
          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "vietnamese": {
        ...
        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "polish": {
        ...
        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "swedish": {
        ...
        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "korean": {
        ...
        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "marathi": {
        ...
        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "azerbaijani": {
        ...
        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **SoniTranslate-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "persian": {
        ...
        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
    ...
    "afrikaans": {
        ...
        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [Gudmarv Easy dubbing](https://github.com/5656wwed/SoniSlowVideo)!**
